...
use crate::hir::{Binding, HExpr, HExprKind, LocalId};
...
impl<'a> Analyzer<'a> {
    pub(in crate::semantics::analyzer) fn analyze_try_expression(
        &mut self,
        ...
        let op_def = self
            .type_ctx
            .defs
            .lookup(crate::types::DefKind::Union, &op_mangled);
        let ret_def = self
            .type_ctx
            .defs
            .lookup(crate::types::DefKind::Union, &ret_mangled);
